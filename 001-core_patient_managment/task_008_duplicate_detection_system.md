...
**What to Build:** Intelligent duplicate patient detection system using fuzzy matching algorithms to prevent duplicate
patient registrations while handling variations in names, phone numbers, and addresses common in Algerian healthcare
settings.

**Why:** Prevent duplicate patient records that can lead to fragmented medical histories, billing errors, and
compromised patient care quality by detecting potential duplicates during registration.
...
1. **Real-Time Duplicate Detection**
    ...
    - Acceptance Criteria:
        ...
        - Real-time checking with fast response time
    ...
    async mergePatients(
        ...
        try {
            ...
            const primaryPatient = await queryRunner.manager.findOne(Patient, {
                ...
                relations: ['contactInfo', 'emergencyContacts']
            });
...
- [ ] Real-time duplicate detection responds promptly during registration
