...
### Goal
**What to Build:** Comprehensive multi-language support system with Arabic and French localization, RTL layout support, and proper character encoding for patient data entry and display throughout the patient management system.

**Why:** Support Algerian healthcare providers by providing native language interfaces in Arabic and French, ensuring cultural appropriateness and improved usability for healthcare staff and patients.
...
```yaml
performance:
  - requirement: "Language switching response time"
    target: "< 200ms for language change and UI update"
    
  - requirement: "Translation file loading"
    target: "< 100ms for initial language resource loading"
...
// src/assets/locales/ar/patients.json
{
  "title": "إدارة المرضى",
  "search": {
    "title": "البحث عن المرضى",
    "placeholder": "ابحث بالاسم أو رقم الهاتف أو تاريخ الميلاد",
    "no_results": "لم يتم العثور على نتائج",
    "searching": "جاري البحث...",
    "results_count": "تم العثور على {{count}} مريض",
    "results_count_plural": "تم العثور على {{count}} مرضى"
  },
  "registration": {
    ...
    "error": {
      "creation_failed": "فشل في تسجيل المريض"
    }
  },
  "fields": {
  ...
  "profile": {
    "age_gender": "العمر {{age}} سنة، {{gender}}",
    "tabs": {
      "overview": "نظرة عامة",
...
// src/assets/locales/fr/patients.json
{
  ...
  "search": {
    ...
    "results_count": "{{count}} patient trouvé",
    "results_count_plural": "{{count}} patients trouvés"
  },
  "registration": {
    ...
    "error": {
      "creation_failed": "Échec de l'enregistrement du patient"
    }
  },
  "fields": {
    "first_name": "Prénom",
  ...
  "placeholders": {
    ...
    "last_name": "Entrez le nom de famille",
...
- [ ] Performance requirements met for language switching
