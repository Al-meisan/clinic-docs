...
**What to Build:** Complete NestJS backend API module for patient registration including DTOs, services, controllers,
and repositories with comprehensive validation, audit trail, and duplicate detection.

**Why:** Establish the foundational patient management system that enables digital patient registration for Algerian
healthcare providers, replacing manual paper-based processes.
